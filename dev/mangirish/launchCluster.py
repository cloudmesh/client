...
"""USAGE:
    ...
    Spawns a master and worker cluster on the target cloud, indicated by CLOUD_NAME

    NUMBER_OF_WORKERS: Any integer number
    CLOUD_NAME: vagrant | india | docker | none

    In case of CLOUD_NAME='none' cluster specification would be generated, however the actual machine spawning would be skipped.
...
if sys.argv[1] == "--help":
    print(docopt(__doc__,version='1.0.0cr2'))
